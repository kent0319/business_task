...
class BusinessesControllerTest < ActionController::TestCase
  ...
  test "should create business" do
    assert_difference('Business.count') do
      post :create, business: { alerts: @business.alerts, date: @business.date, detail: @business.detail, title: @business.title }
    end
  ...
  test "should update business" do
    patch :update, id: @business, business: { alerts: @business.alerts, date: @business.date, detail: @business.detail, title: @business.title }
    assert_redirected_to business_path(assigns(:business))
  end
